...
a11exp = Type.create!( code: "a11", flow: "exp", name: "hydrocarbures" )
a11imp = Type.create!( code: "a11", flow: "imp", name: "vrac liquide" )
a12imp = Type.create!( code: "a12", flow: "imp", name: "gaz naturel" )
a1exp = Type.create!( code: "a1", flow: "exp", name: "vrac liquide" )
a1imp = Type.create!( code: "a1", flow: "imp", name: "tonnage brut total" )
a21exp = Type.create!( code: "a21", flow: "exp", name: "cereales" )
a25imp = Type.create!( code: "a25", flow: "imp", name: "minerais" )
a26imp = Type.create!( code: "a26", flow: "imp", name: "engrais" )
a2exp = Type.create!( code: "a2", flow: "exp", name: "vrac solide" )
a2imp = Type.create!( code: "a2", flow: "imp", name: "VL hors hydrocarbures" )
a32exp = Type.create!( code: "a32", flow: "exp", name: "roro hors cntr (T)" )
a32imp = Type.create!( code: "a32", flow: "imp", name: "conteneur roro (T)" )
a33exp = Type.create!( code: "a33", flow: "exp", name: "conventionel et colis lourd" )
a33imp = Type.create!( code: "a33", flow: "imp", name: "vehicule roulant (T)" )
a3exp = Type.create!( code: "a3", flow: "exp", name: "non vrac" )
a3imp = Type.create!( code: "a3", flow: "imp", name: "autres vracs solides" )
aexp = Type.create!( code: "a", flow: "exp", name: "tonnage brut total" )
aimp = Type.create!( code: "a", flow: "imp", name: "navires (nb)" )
b11exp = Type.create!( code: "b11", flow: "exp", name: "cntr vide 20' (nb)" )
b11imp = Type.create!( code: "b11", flow: "imp", name: "cntr vide (nb)" )
b1exp = Type.create!( code: "b1", flow: "exp", name: "cntr vide (nb)" )
b1imp = Type.create!( code: "b1", flow: "imp", name: "conteneur (nb)" )
b21exp = Type.create!( code: "b21", flow: "exp", name: "cntr plein 20' (nb)" )
b21imp = Type.create!( code: "b21", flow: "imp", name: "cntr plein (nb)" )
b2exp = Type.create!( code: "b2", flow: "exp", name: "cntr plein (nb)" )
b2imp = Type.create!( code: "b2", flow: "imp", name: "cntr vide > 40' (nb)" )
bexp = Type.create!( code: "b", flow: "exp", name: "conteneur (nb)" )
bimp = Type.create!( code: "b", flow: "imp", name: "conventionel et colis lourd" )
d1exp = Type.create!( code: "d1", flow: "exp", name: "pax hors croisieres" )
d1imp = Type.create!( code: "d1", flow: "imp", name: "passagers" )
d2imp = Type.create!( code: "d2", flow: "imp", name: "pax hors croisieres" )
d3exp = Type.create!( code: "d3", flow: "exp", name: "pax croisieres escale" )
d3imp = Type.create!( code: "d3", flow: "imp", name: "pax croisieres tete de ligne" )
dexp = Type.create!( code: "d", flow: "exp", name: "passagers" )
dimp = Type.create!( code: "d", flow: "imp", name: "plein (EVP)" )
eexp = Type.create!( code: "e", flow: "exp", name: "navires (nb)" )
eimp = Type.create!( code: "e", flow: "imp", name: "pax croisieres escale" )
